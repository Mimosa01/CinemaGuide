...
interface PropsMobilNav {
  onClick: () => void;
}

export const MobileNav: FC<PropsMobilNav> = ({onClick}) => {
  return (
    <nav className='mobile-nav'>
      <Link to={path.genre} className='mobile-nav__link'>
      ...
      <Button view={{none: true}} className="mobile-nav__link" onClick={onClick}>
